...
public abstract class XppActivityReader implements XppReader<ActivityEntry> {
    ...
    protected ActivityActor parseActor(XmlPullParser parser)
     ...
     * @throws IOException
     */
    protected AtomPerson parsePerson(XmlPullParser parser)
        throws XmlPullParserException, IOException {
     ...
     * @throws IOException
     */
    protected void readAtomPersonElement(AtomPerson person,
